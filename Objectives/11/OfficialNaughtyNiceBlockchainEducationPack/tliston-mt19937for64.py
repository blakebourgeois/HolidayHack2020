...
if __name__ == "__main__":
    ...
    for i in range(mt19937.n):
        # the randrange implementation creates multiple 32bit words, as many as needed to fit in the request
    ...
    for i in range(count2):
        f = random.randrange(0xFFFFFFFFFFFFFFFF)
        # to stay in sync with rand, which is generating two 32bit words per 0xFFFFFFFFFFFFFFFF generation we extract two numbers per every randrange call
    ...
    for i in range(20):
        ...
        # the two pnrgs are in agreement
